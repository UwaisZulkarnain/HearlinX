...
qr.add_data('https://github.com/UwaisZulkarnain/HearlinX/releases/latest/download/DengarTrack.apk')
qr.make(fit=True)

img = qr.make_image(fill_color="#0F766E", back_color="white").convert('RGB')

draw = ImageDraw.Draw(img)
text = "DengarTrack App"
try:
...
new_img.save('misc\\Qr_generators\\dengartrack_APK_file.png')