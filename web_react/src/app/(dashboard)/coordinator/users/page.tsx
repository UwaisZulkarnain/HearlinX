...
export default function CoordinatorUsersPage() {
  ...
  const labels =
    lang === "ms"
      ? {
          title: "Urus Pengguna",
          description: "Tambah dan urus penyaring untuk hospital anda.",
          createTitle: "Tambah Penyaring",
          staffId: "ID Staf",
          fullName: "Nama Penuh",
          pin: "PIN",
          ...
          created: "Pengguna berjaya ditambah",
          error: "Gagal mengemas kini",
        }
      : {
          title: "Manage Users",
          description: "Add and manage screeners for your hospital.",
          createTitle: "Add Screener",
          staffId: "Staff ID",
          fullName: "Full Name",
          pin: "PIN",
          create: "Add User",
  ...
  async function loadUsers() {
    ...
    try {
      ...
      setUsers(response.data.filter((user) => user.role === "screener"));
    } catch (error) {
    ...
    <DashboardLayout roleLabel={t("coordinator")} title={labels.title}>
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-5">
        <Card className="border-slate-200 bg-white shadow-sm">
          ...
          <CardContent>
            <form className="grid gap-3 md:grid-cols-[1fr_1.5fr_1fr_auto]" onSubmit={createUser}>
              ...
              <Button className="bg-[#0F766E] text-white hover:bg-[#115E59]" disabled={isSaving} type="submit">{labels.create}</Button>
            </form>
          </CardContent>
        </Card>
            ...
            <Table>
              ...
              <TableBody>
                ...
                {!isLoading && users.length === 0 ? (
                  <TableRow><TableCell className="text-center text-slate-500" colSpan={4}>{t("notRecorded")}</TableCell></TableRow>
                ) : null}
              </TableBody>
            </Table>
          </CardContent>
